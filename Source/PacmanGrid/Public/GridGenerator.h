...
private:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Nodes")
		TSubclassOf<AGridBaseNode> GateNode;
	...
	UPROPERTY(EditDefaultsOnly, Category = "Nodes")
		TSubclassOf<AGridBaseNode> TunnelNode;

	UPROPERTY(EditDefaultsOnly, Category = "Nodes")
		TSubclassOf<AGridBaseNode> OutsideLabyrinthNode;
...
protected:
	...
	//used to set isCrossNode attributes in crossNodes for ghosts path compuatation
	bool isWalkableChar(const char& node);
